<template>
	<div class="System_control">
				<div class="admin_serch">
					...
					<div class="pull">
						<el-button type="success" round icon="el-icon-circle-plus" @click='dialog_System'>新增</el-button>
					</div>
					<div class="pull">
				...
				<el-table :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)" 
					...
					<el-table-column prop="cnumber" label="参数编号" width="130">
					</el-table-column>
					<el-table-column prop="name" label="参数名" width="130">
					</el-table-column>
					<el-table-column prop="opsition" label="参数值" width='130'>
					</el-table-column>
					<el-table-column prop="opsition" label="参数描述">
					</el-table-column>
...
<script>
	...
	import Systemxiugai from './Systemxiugai'
	...
	methods: {
		...
		dialog_System() { //新增页
			this.bus.$emit('addSystem_show', true)
		},
		deleat_all() { //批量删除
		...
		amendClick(i) { //编辑当前页
			...
			this.bus.$emit('xiugai_System', true)
		}
	}
}</script>
