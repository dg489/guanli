	...
	<div class="checkrule">
 	 ...
 	 :before-close="drugClose">
		<el-card class="box-card">
			...
			<p>操作人：</p>
			<p class="check_number">
				{{msg.cnumber}}
			</p>
			<p>柜名称:</p>
			<p class="check_number">{{msg.c_name}}</p>
			<p>位置:</p>
			<p class="check_number">{{msg.opsition}}</p>
			<div style="display: flex;margin-bottom: 6px;">
				<div style="flex: 1;">
					<p>事件：</p>
					<p class="check_number" style="margin-right: 20px;">{{msg.opsition}}</p>
				</div>
				<div style="flex: 1;">
					<p>时间：</p>
					<p class="check_number" >{{msg.opsition}}</p>
